...
exec "Snippet scriptsrc <script src=\"".st.et."\" type=\"text/javascript\" language=\"javascript".st.et."\" charset=\"Shift_JIS".st.et."\"></script><CR>".st.et

" Embedded stype sheet
exec "Snippet css <style type=\"text/css\" media=\"screen\"><CR>/* <![CDATA[ */<CR>".st.et."<CR>/* ]]> */<CR></style><CR>".st.et
